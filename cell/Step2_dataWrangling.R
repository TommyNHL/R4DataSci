...
p1 <- ggplot(myTPM.stats) + 
          ...
          labs(y="Median", x = "Standard deviation", 
               ...
               caption="RNA-Seq: TGFβ-Treated LX-2 Cells & Control Groups") +
          theme_classic() +
          theme_dark() + 
          theme_bw()
p1
...
log2.cpm.df.pivot <- pivot_longer(
    ...
    cols = 'LX-2_control1':'LX-2_treat3', # column names to be stored as a SINGLE variable
...
# save
write.csv(myDGEList@.Data[1], "../myDGEListSRR275967.csv")
write.csv(log2.cpm.df, "../myDGEListSRR275967log2.csv")

save(myDGEList.filtered, file = "../myDGEListSRR275967Filter")
write.csv(myDGEList.filtered@.Data[1], "../myDGEListSRR275967_filtered.csv")
write.csv(log2.cpm.filtered.df, "../myDGEListSRR275967log2_filtered.csv")

save(myDGEList.filtered.norm, file = "../myDGEListSRR275967FilterNorm")
write.csv(myDGEList.filtered.norm@.Data[1], "../myDGEListSRR275967_filtered_normalized.csv")
write.csv(log2.cpm.filtered.norm.df, "../myDGEListSRR275967log2_filtered_normalized.csv")
...
write.csv(cpm.filtered.norm.df, "../myDGEListSRR275967log2FALSE_filtered_normalized.csv")
