...
myTopHits <- topTable(ebFit, adjust ="none", coef=1, number=16018, sort.by="logFC")
...
gseaplot2(myGSEA.res,
          geneSetID = c(167, 275, 126, 129, 174, 336, 413, 437, 290, 461, 
                        403, 485, 557, 314, 489, 240, 217, 244, 533, 191, 
                        420, 483, 123, 158), 
...
myGSEA.df <- myGSEA.df[c(167, 275, 126, 129, 174, 336, 413, 437, 290, 461, 
                         403, 485, 557, 314, 489, 240, 217, 244, 533, 191, 
                         420, 483, 123, 158),] %>% 
...
ggplot(myGSEA.df[1:24,], aes(x=phenotype, y=ID)) +
